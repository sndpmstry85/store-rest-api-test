from werkzeug.security import safe_str_cmp  # safe_str_cmp used for comparing strings across python 2.7 and 3.5+
from models.user import UserModel


def authenticate(username, password):
    """
    Function that gets called when a user calls  /auth endpoint
    ...
    """
    user = UserModel.find_by_username(username)  # this checks for the username password is correct then returns user
